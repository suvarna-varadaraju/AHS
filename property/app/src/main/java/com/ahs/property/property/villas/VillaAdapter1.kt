...
class VillaAdapter1 (private val heroList: ArrayList<ResidentModel>, val context: Context,
                    private val listener: OnItemClickListener
) : RecyclerView.Adapter<VillaAdapter1.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
     ...
     /*   holder.itemView.logo.setOnClickListener {
        ...
        holder.itemView.setOnClickListener {
            val browserIntent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://ahs-properties.com/project/searenity/"))
