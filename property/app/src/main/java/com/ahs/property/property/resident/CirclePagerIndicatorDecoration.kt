...
class CirclePagerIndicatorDecoration(colorInactive: Int, colorActive: Int) : RecyclerView.ItemDecoration() {

    companion object {
        private val DP: Float = android.content.res.Resources.getSystem().displayMetrics.density
    }

    private var colorActive = colorActive
    private var colorInactive = colorInactive
