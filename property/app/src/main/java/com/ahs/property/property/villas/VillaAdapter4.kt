...
class VillaAdapter4 (private val heroList: ArrayList<ResidentModel>, val context: Context,
                    private val listener: OnItemClickListener
) : RecyclerView.Adapter<VillaAdapter4.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
      ...
      /*  holder.itemView.logo.setOnClickListener {
        ...
        holder.itemView.setOnClickListener {
            val browserIntent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://ahs-properties.com/project/serene/"))
