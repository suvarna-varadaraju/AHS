            ...
            when(position) {
                0 -> {
                    if(isNetworkAvailable(this)) {
                        ...
                        intent.putExtra(
                            "download",
                            "https://drive.google.com/uc?export=download&id=15jN_q7aZNZOgJDOdEoRQKp36Nlw1l3rZ"
                        )
                        intent.putExtra(
                            "view",
                            "https://drive.google.com/uc?export=view&id=15jN_q7aZNZOgJDOdEoRQKp36Nlw1l3rZ"
                        )
